...
// * reducers
import { addBook } from '../../../redux/slices/bookshelf-slices';
...
export default function BodyFormAddBook({ toastRef }) {
  const dispatch = useDispatch();
  const [formAddBook, setFormAddBook] = useState(initialValueFormAddBook);
  ...
  const HandlerSubmit = (e) => {
    e.preventDefault();
    dispatch(addBook({ id: `${uniqid()}-rakbukuku`, ...formAddBook }));
